...
<form action ="Deleteproduct" method="post" id="form">
<div class=personal><h1>Delete product</h1>
<div class="one"><label for="number">Product code</label><input type="number" id="pcode" name="pc"></div>
